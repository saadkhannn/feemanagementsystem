		...
		var table = $('.datatable-serverside').DataTable({
            ...
            initComplete: function (settings, json) {
                ...
                table.columns().every(function () {
                    ...
                    var input = $('<input type="text" style="width: '+(count == 1 ? '85px' : '100%')+' !important;" class="form-control text-center"  placeholder="'+header+'"/><span style="display: none">'+header+'</span>')
