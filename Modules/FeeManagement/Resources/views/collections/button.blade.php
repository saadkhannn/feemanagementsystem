...
@endphp
@if($bills-$collections > 0)
<a class="btn btn-sm btn-info text-white" onclick="Show('Student Fee Collection for #{{ $user->first_name.' '.$user->last_name }}','{{ url('fee-management/fee-collections/'.$user->id.'/edit') }}')">Collect Fee</a>
@endif